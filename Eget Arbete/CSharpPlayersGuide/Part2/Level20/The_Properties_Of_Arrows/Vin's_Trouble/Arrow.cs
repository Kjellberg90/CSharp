...
namespace Vin_Fletcher_s_Arrows
{
    class Arrow
    {
        ...
        public static double EliteArrow()
        {
            double sum = 24.75;
            Console.WriteLine($"You have bought an elite arrow for {sum} gold");
            return sum;
        }

        public static double BeginnerArrow()
        {
            double sum = 9.75;
            Console.WriteLine($"You have bought an elite arrow for {sum} gold");
            return sum;
        ...
        public static double MarksmanArrow()
        {
            double sum = 16.25;
            Console.WriteLine($"You have bought an elite arrow for {sum} gold");
            return sum;
